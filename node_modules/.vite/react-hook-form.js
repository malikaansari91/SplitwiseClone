import {
  require_react
} from "./chunk-4ISKNX7T.js";
import "./chunk-GVP5UEJM.js";
import {
  __toModule
...
var FormProvider = (props) => import_react.default.createElement(HookFormContext.Provider, { value: omit(props, "children") }, props.children);
...
function useFormState(props) {
  ...
  _name.current = name;
  const callback = import_react.default.useCallback((value) => _mounted.current && shouldSubscribeByName(_name.current, value.name, exact) && shouldRenderFormState(value, _localProxyFormState.current) && updateFormState(Object.assign(Object.assign({}, control._formState), value)), [control, exact]);
  useSubscribe({
    disabled,
    callback,
...
function useController(props) {
  ...
  const _registerProps = import_react.default.useRef(control.register(name, Object.assign(Object.assign({}, props.rules), { value })));
  import_react.default.useEffect(() => {
...
var useFieldArray = (props) => {
  ...
  return {
    ...
    fields: import_react.default.useMemo(() => fields.map((field, index) => Object.assign(Object.assign({}, field), { [keyName]: ids.current[index] || generateId() })), [fields, keyName])
  };
};
